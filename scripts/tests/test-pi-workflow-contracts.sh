...
require_text pi/agent/extensions/subagent/capture.ts 'stdout: 64 * 1024 * 1024'
require_text pi/agent/extensions/subagent/capture.ts 'line: 16 * 1024 * 1024'
require_text pi/agent/extensions/subagent/capture.ts 'retained: 8 * 1024 * 1024'
require_text pi/agent/extensions/subagent/capture.ts 'stderr: 256 * 1024'
